...
class DepartmentResource extends Resource
{
    ...
    /**
     * Departments are basic org structure - MD, HR Director, and IT
     * (for user account setup) manage these.
     */
    public static function canViewAny(): bool
    {
        return auth()->user()?->hasAnyRole(['md', 'hr_director', 'it_technician']) ?? false;
    }
